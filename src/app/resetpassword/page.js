        ...
        <div className="container px-5 mx-auto md:bg-green-300 md:w-[50%] rounded-xl shadow-2xl">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button
                  className="flex ml-0 text-black bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 hover:text-slate-100 font-semibold w-full justify-center"
