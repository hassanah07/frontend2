      ...
      <section className="text-gray-600 body-font relative md:w-[70%] pb-14">
        <div className="container px-5 mx-auto md:bg-green-300 md:w-[50%] rounded-xl shadow-2xl">
          <div className="flex flex-col text-center w-full py-2">
            <h2 className="sm:text-3xl text-2xl font-medium title-font my-4 text-gray-700 dark:text-slate-100 font-semibold">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button
                  className="flex ml-0 text-black bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 hover:text-slate-100 text-lg justify-center"
