...
const AdSenseBlogSideTwo = () => {
  useEffect(() => {
    ...
    const adsenseContainer = document.getElementById("adsense--blog-side-Two");
    if (adsenseContainer) {
      (adsbygoogle = window.adsbygoogle || []).push({
        className: "adsbygoogle-blog-side-two"
      });
    }
  }, []);

  return (
    <div id="adsense--blog-side-Two" className="rounded-lg shadow-2xl">
      <ins
        className="adsbygoogle-blog-side-two"
        style={{ display: "block" }}
        data-ad-client="ca-pub-2409909836337800"
        data-ad-slot="6393138719"
        data-ad-format="auto"
...
export default AdSenseBlogSideTwo;
